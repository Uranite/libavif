...
cmake -G Ninja -S aom -B aom/build.libavif -DBUILD_SHARED_LIBS=OFF -DCMAKE_BUILD_TYPE=Release -DENABLE_DOCS=0 -DENABLE_EXAMPLES=0 -DENABLE_TESTDATA=0 -DENABLE_TESTS=0 -DENABLE_TOOLS=0 -DCMAKE_C_FLAGS="-flto -fuse-ld=lld -march=znver2" -DCMAKE_CXX_FLAGS="-flto -fuse-ld=lld -march=znver2"
...
if exist SVT-AV1 (
    ...
    git clone --depth 300 --branch ghostrobot https://github.com/juliobbv-p/svt-av1-hdr.git
)
cmake -G Ninja -S SVT-AV1 -B SVT-AV1/build.libavif -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DSVT_AV1_LTO=OFF -DENABLE_AVX512=ON -DBUILD_APPS=OFF -DCMAKE_CXX_FLAGS_RELEASE="-flto -fuse-ld=lld -O3 -DNDEBUG -march=znver2" -DCMAKE_C_FLAGS_RELEASE="-flto -fuse-ld=lld -O3 -DNDEBUG -march=znver2"
...
set "CFLAGS=-flto -fuse-ld=lld -O3 -DNDEBUG -march=znver2"
set "CXXFLAGS=-flto -fuse-ld=lld -O3 -DNDEBUG -march=znver2"
